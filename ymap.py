...
import sys, os
from texture import GX, readTextureData, decodeTexturePIL
...
for i in range(nRegions):
    ...
    fin.seek(dataOffset)
    data = readTextureData(fin, GX.TF_I8, width, height)
    
    images = decodeTexturePIL(data, GX.TF_I8, width, height, 0, None)
